...
export type TemplateField = {
  key: string; // path inside credentialSubject or top-level field
  label: string;
...
export type CredentialTemplate = {
  ...
  title: string;
  description: string;
  vcType: string; // second type alongside VerifiableCredential
  ...
  const templates: CredentialTemplate[] = [
    {
      ...
      fields: [
        { key: "subject", label: "Subject DID", type: "did", required: true, placeholder: "Wallet (G...) – we derive DID" },
        { key: "degreeName", label: "Degree Name", type: "text", required: true, placeholder: "Bachelor of Engineering" },
        { key: "institution", label: "Institution", type: "text", required: true, placeholder: "Example University" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "documentType", label: "Document Type", type: "text", required: true, placeholder: "Passport" },
