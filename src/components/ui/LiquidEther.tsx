...
`;
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh;
      private simProps!: { cellScale: THREE.Vector2; cursor_size: number } & Record<
        string,
        unknown
      >;
      constructor(simProps: any) {
        super({ output: simProps.dst });
        this.simProps = simProps as { cellScale: THREE.Vector2; cursor_size: number } & Record<
          string,
          unknown
        >;
        this.init();
          ...
          uniforms: {
            ...
            scale: {
              value: new THREE.Vector2(
                this.simProps.cursor_size as number,
                this.simProps.cursor_size as number
              ),
            },
          },
